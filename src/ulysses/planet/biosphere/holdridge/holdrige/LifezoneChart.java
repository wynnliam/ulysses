...
public class LifezoneChart
{
    ...
    private class Lifezone
    {
         ...
         * @param index a value from 0 to 6, since this is a hexagon.
         * @return null if index is invalid, or the BiotempPrecipPoint at
         * at the index.
         */
         ...
         * @return the distance between point and the centroid of the lifezone.
         */
    ...
    private class BiotempPrecipPoint
    {
         ...
         * @return the distance from this point to point.
         */
        public double getDistance(BiotempPrecipPoint point)
        {
            if(point == null)
        ...
        /**
         * @param biotemp the biotemp to set
         */
